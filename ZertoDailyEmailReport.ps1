...
################################################
$EmailList1	= "Distro@foo.com"
$EmailFrom	= "Zerto@foo.com"
$SMTPServer	= "smtprelay.foo.com"
$SMTPPort	= "25"
$SMTPSSLEnabled	= "FALSE"
# Creating SMTP Profiles
$SMTPProfile1 = @("$EmailFrom",“$SMTPServer”,”$SMTPPort”,”$SMTPSSLEnabled”)
################################################
...
$vCenterArrayLine |	Add-Member -MemberType NoteProperty -Name "SourcePOD" -Value "Zerto PRD Site"
$vCenterArrayLine |	Add-Member -MemberType NoteProperty	-Name "SourcevCenter" -Value "VCENTER.FOO.COM"
$vCenterArrayLine |	Add-Member -MemberType NoteProperty	-Name "SourceZVM" -Value "PZVM01.FOO.COM"
$vCenterArrayLine |	Add-Member -MemberType NoteProperty	-Name "TargetPOD" -Value "Zerto DR Site"
$vCenterArrayLine |	Add-Member -MemberType NoteProperty	-Name "TargetvCenter" -Value "DR-VCENTER.FOO.COM"
$vCenterArrayLine |	Add-Member -MemberType NoteProperty	-Name "TargetZVM" -Value "SZVM01.FOO.COM"
...
<style type="text/css">
.tg	{border-collapse:collapse;border-spacing:0;border-color:#aaa;table-layout:fixed;width:100%;margin-left:auto;margin-right:auto;}
.tg	td{font-family:Arial,sans-serif;font-size:10px;text-align:center;padding:1px 1px;border-style:solid;border-width:0px;overflow:hidden;word-break:normal;border-color:#aaa;color:#333;background-color:#ffffff;border-top-width:1px;border-bottom-width:1px;}
.tg	th{font-family:Arial,sans-serif;font-size:10px;font-weight:bold;padding:1px 1px;border-style:solid;border-width:0px;overflow:hidden;word-break:normal;border-color:#aaa;color:$TableFont;background-color:$TableBorder;border-top-width:1px;border-bottom-width:1px;}
.tg	.tg-foxd{background-color:$TableBackground;vertical-align:top;text-align:center;}
.tg	.tg-yw4l{vertical-align:top;table-layout:fixed;}
...
$SourceZVMBaseResourceReportURL = "https://" + $SourceZVM + ":"+"9669"
...
$ResourceReportURL = $TargetZVMBaseResourceReportURL + $ResourceReprtString + $NowDateTime + "&toTimeString=" + $ThenDateTime + "&startIndex=0&count=500"
...
# Building Email Body
$Body = $ReportHTMLTableStyle + $PODSummaryArrayHTML + $ProtectedVPGArrayHTML + $TargetDatastoreArrayHTML
...
# Sending the email
Email-ZVRReport -EmailTo $EmailList1 -Subject $Subject -Body $Body -SMTPProfile $SMTPProfile1
